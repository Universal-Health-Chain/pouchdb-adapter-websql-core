...
import {
  ...
  function fetchAttachmentsIfNecessary(doc: any, opts: any, api: any, txn: any, cb: any) {
    ...
    function fetchAttachment(doc: any, att: any) {
      var attObj = doc._attachments[att];
      var attOpts = {binary: opts.binary, ctx: txn};
      api._getAttachment(doc._id, att, attObj, attOpts, function (_: any, data: any) {
  ...
  export function WebSqlPouch(this: any, opts: any, callback: any) {
    var api = this;
    var instanceId: null = null;
    ...
    function runMigration2(tx: any, callback: any) {
    ...
    function runMigration3(tx: any, callback: any) {
      ...
      tx.executeSql(local, [], function () {
        ...
        tx.executeSql(sql, [], function (tx: any, res: any) {
          var rows: any[] = [];
          ...
          function doNext() {
            ...
            tx.executeSql('INSERT INTO ' + LOCAL_STORE +
                ' (id, rev, json) VALUES (?,?,?)',
                [row.id, rev, row.data], function (tx: any) {
              tx.executeSql('DELETE FROM ' + DOC_STORE + ' WHERE id=?',
                  [row.id], function (tx: any) {
    ...
    function runMigration4(tx: any, callback: any) {
      ...
      tx.executeSql(sql, [], function (tx: any) {
        ...
        tx.executeSql(sql, [], function (tx: any) {
          tx.executeSql(BY_SEQ_STORE_DOC_ID_REV_INDEX_SQL, [], function (tx: any) {
    ...
    // for issue #2818
    function runMigration5(tx: any, callback: any) {
  
      function migrateAttsAndSeqs(tx: any) {
        ...
        tx.executeSql(sql, [], function (tx: any, res: any) {
          ...
          function nextPage() {
            ...
            tx.executeSql(sql, [], function (tx: any, res: any) {
              ...
              var digestSeqs: any = {};
              function addDigestSeq(digest: any, seq: any) {
              ...
              var digestSeqPairs: any = [];
              Object.keys(digestSeqs).forEach(function (digest) {
                var seqs = digestSeqs[digest];
                seqs.forEach(function (seq: any) {
              ...
              var numDone = 0;
              digestSeqPairs.forEach(function (pair: any) {
      ...
      tx.executeSql(attachAndRev, [], function (tx: any) {
        tx.executeSql(
          ATTACH_AND_SEQ_STORE_ATTACH_INDEX_SQL, [], function (tx: any) {
            tx.executeSql(
    ...
    function runMigration6(tx: any, callback: any) {
    ...
    function runMigration7(tx: any, callback: any) {
    ...
    function checkEncoding(tx: any, cb: any) {
      // UTF-8 on chrome/android, UTF-16 on safari < 7.1
      tx.executeSql('SELECT HEX("a") AS hex', [], function (tx: any, res:any) {
    ...
    function onGetVersion(tx: any, dbVersion: number) {
      if (dbVersion === 0) {
        // initial schema
        ...
        var i = dbVersion;
        var nextMigration = function (tx: any) {
    ...
    function getMaxSeq(tx: any, callback: any) {
    ...
    function countDocs(tx: any, callback: any) {
    ...
    api._id = toPromise(function (callback: any) {
    ...
    api._info = function (callback: any) {
      ...
      db.readTransaction(function (tx: any) {
        getMaxSeq(tx, function (theSeq: any) {
          seq = theSeq;
        });
        countDocs(tx, function (theDocCount: any) {
    ...
    api._bulkDocs = function (req: any, reqOpts: any, callback: any) {
      websqlBulkDocs(opts, req, reqOpts, api, db, websqlChanges, callback);
    };
  
    function latest(tx: any, id: any, rev: any, callback: any, finish: any) {
      var sql: any = select(
          SELECT_DOCS,
          [DOC_STORE, BY_SEQ_STORE],
          DOC_STORE_AND_BY_SEQ_JOINER,
      ...
      tx.executeSql(sql, sqlArgs, function (a: any, results: any) {
    ...
    api._get = function (id: any, opts: any, callback: any) {
      var doc: any;
      var metadata: { id: string; };
      var tx = opts.ctx;
      if (!tx) {
        return db.readTransaction(function (txn: any) {
          api._get(id, Object.assign({ctx: txn}, opts), callback);
        });
      }
  
      function finish(err: any): any {
      ...
      if (!opts.rev) {
        ...
        latest(tx, id, opts.rev, function (latestRev: any) {
          opts.latest = false;
          opts.rev = latestRev;
    ...
    api._allDocs = function (opts: any, callback: any) {
      ...
      db.readTransaction(function (tx: any) {
        ...
        countDocs(tx, function (docCount: any) {
          totalRows = docCount;
        });
        ...
        if (keys) {
          ...
          keyChunks.forEach(function (keyChunk) {
            ...
            tx.executeSql(sql, sqlArgs, function (tx: any, result: any) {
              finishedCount++;
        ...
        function processResult(rows: any) {
          ...
          for (var i = 0, l = rows.length; i < l; i++) {
            ...
            if (!keys) {
              ...
              var index: any = keys.indexOf(id, index);
              do {
                results[index] = doc;
          ...
          if (keys) {
            keys.forEach(function (key: any, index: any) {
              if (!results[index]) {
    ...
    api._changes = function (opts: any) {
      ...
      function fetchChanges() {
        ...
        db.readTransaction(function (tx: any) {
          tx.executeSql(sql, sqlArgs, function (tx: any, result: any) {
            function reportChange(change: any) {
              return function () {
    ...
    api._getAttachment = function (docId: any, attachId: any, attachment: any, opts: any, callback: any) {
      var res;
      var tx = opts.ctx;
      ...
      tx.executeSql(sql, [digest], function (tx: any, result: any) {
    ...
    api._getRevisionTree = function (docId: any, callback: any) {
      db.readTransaction(function (tx: any) {
        var sql = 'SELECT json AS metadata FROM ' + DOC_STORE + ' WHERE id = ?';
        tx.executeSql(sql, [docId], function (tx: any, result: any) {
          if (!result.rows.length) {
    ...
    api._doCompaction = function (docId: any, revs: any, callback: any) {
      if (!revs.length) {
        return callback();
      }
      db.transaction(function (tx: any) {
        ...
        tx.executeSql(sql, [docId], function (tx: any, result: any) {
          ...
          traverseRevTree(metadata.rev_tree, function (isLeaf: any, pos: string, revHash: string, ctx: any, opts: any) {
            var rev = pos + '-' + revHash;
    ...
    api._getLocal = function (id: string, callback: any) {
      db.readTransaction(function (tx: any) {
        ...
        tx.executeSql(sql, [id], function (tx: any, res: any) {
          if (res.rows.length) {
    ...
    api._putLocal = function (doc: any, opts: any, callback: any) {
      ...
      var ret: { ok: boolean; id: any; rev: any; };
      function putLocal(tx: any) {
        var sql;
        var values;
        if (oldRev) {
        ...
        tx.executeSql(sql, values, function (tx: any, res: any) {
          if (res.rowsAffected) {
    ...
    api._removeLocal = function (doc: any, opts: any, callback: any) {
      ...
      var ret: { ok: boolean; id: any; rev: string; };
  
      function removeLocal(tx: any) {
        var sql = 'DELETE FROM ' + LOCAL_STORE + ' WHERE id=? AND rev=?';
        var params = [doc._id, doc._rev];
        tx.executeSql(sql, params, function (tx: any, res: any) {
          if (!res.rowsAffected) {
